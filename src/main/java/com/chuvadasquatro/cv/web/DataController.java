...
import com.chuvadasquatro.cv.service.DataService;
...
public class DataController {
	...
	public String uploadData(@RequestParam("data") MultipartFile data, RedirectAttributes attr) throws Exception {
		if (data.isEmpty()) {
